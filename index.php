...
<body>
	...
	<div class="container mt-5 mb-4" id="cont">
		...
		<p class="bg-primary text-light" style="padding-left:5px"> Περιγραφή ομάδων χρηστών / διαδικασιών</p>
		<p>
		...
		διεργασίες. Συγκεκριμένα, ο κάθε φοιτητής έχει:</p>
		<ul>
			...
			<li> Έλεγχος του πλήρους ιστορικού δηλώσεων του εκάστοτε χρήστη</li>
		</ul>
		<p>Αντίστοιχα, το κάθε σημείο διανομής:</p>
		<ul>
			<li> Δυνατότητα επιλογής και προβολής των διαθέσιμων συγγραμμάτων για το εκάστοτε εξάμηνο</li>
			<li> Εύκολη παράδοση συγγραμμάτων</li>
		</ul>
	</div><br><br><br>
